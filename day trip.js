...
let randomRestruant = resturant[Math.floor(Math.random()*resturant.length)]
...
if (userInput == "Yes"){
        ...
        return randomDestinationCity
        return randomRestruant
        return randomtypeOfTransportation
        return randomTypeOfEntertainment
...
if (satisfaction == "Yes" || satisfaction == "yes"){
    ...
    return randomTypeOfEntertainment
        ...
        prompt("Please select Yes or No. Would you like to go on a day trip? ")
  }
else { 
